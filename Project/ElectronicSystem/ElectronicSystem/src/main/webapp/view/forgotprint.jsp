...
<form action="savepasswordprint" method="post" name="form">
    <input type="hidden" name="id" value="${p.id}"/>
    <table>
        <tr>
            <td>Name </td>
            <td><input type="text" name="name" value="${p.name}" readonly></td>
        </tr>
        ...
        <tr>
            <td>User Name </td>
            <td><input type="text" name="username" value="${p.username}" readonly></td>
        </tr>
        <tr>
