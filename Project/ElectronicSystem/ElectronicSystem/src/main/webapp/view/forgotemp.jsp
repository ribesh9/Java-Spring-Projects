...
<form action="savepassword" method="post" name="form">
    ...
    <table>
        ...
        <tr>
            <td>Email </td>
            <td><input type="text" name="email" value="${emp.email}" readonly></td>
        </tr>
        <tr>
            <td>Phone </td>
        ...
        <tr>
            <td>User Name </td>
            <td><input type="text" name="username" value="${emp.username}" readonly></td>
        </tr>
        <tr>
...
<script>
    	function validate(){
    		...
    		if(!name.match(namexp)){
    			...
    			alert("The  passwords on both must be same");
    			return false;
    		}
    		return true;
